...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('f5b8b4', 'f88982', 'fc584e', 'FD0F00')  # Obb_v2_Red
        # hex = ('95ff00', "4dbc00", "2e790e", "4bf401")  # Hbb_v2_Green
        # hex = ("189ad3", '0c38e2', '1b4972', "351c75")  # Hbb_V1_Blue
...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=2048, max_subplots=4):
    ...
    annotator = Annotator(mosaic, line_width=round(fs/100), font_size=fs, pil=True)
    for i in range(i + 1):
        x, y = int(w * (i // ns)), int(h * (i % ns))  # block origin
